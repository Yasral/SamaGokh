<section class="bg-primaryColor pb-4">

    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">

        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
            <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900">Evenements</h2>
        </div> 

        <ol class="relative border-l bg-white py-12 border-gray-200"> 

            <li class="mb-10 ml-6 border-b border-thirdAlternative">            
                <span class="flex absolute -left-3 justify-center items-center w-6 h-6 bg-secondaryColor rounded-full ring-8 ring-white">
                ...
                <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 ">Journee Porte Ouvertes <span class="bg-secondaryColor text-white text-sm font-medium ml-2 px-2.5 py-0.5 rounded ">Recent</span></h3>
            ...
            <li class="mb-10 ml-6 border-b border-thirdAlternative">
                ...
                <h3 class="mb-1 text-lg font-semibold text-gray-900">Kermesse De La Commune</h3>
                <time class="block mb-2 text-sm font-normal leading-none text-gray-400">Released on December 7th, 2021</time>
                <p class="mb-4 text-base font-normal text-gray-500">All of the pages and components are first designed in Figma and we keep a parity between the two versions even as we update the project.</p>
            </li>
            
            <li class="ml-6 border-b border-thirdAlternative">
                <span class="flex absolute -left-3 justify-center items-center w-6 h-6 bg-secondaryColor rounded-full ring-8 ring-white">
                    <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path></svg>
                </span>
                <h3 class="mb-1 text-lg font-semibold text-gray-900">Journee De La Jeunesse</h3>
