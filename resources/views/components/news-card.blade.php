    ...
    <section class="bg-thirdAlternative">

        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">

            <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900">Actualites</h2>
            </div> 
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <img class="w-7 h-7 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="Admin" />
                        ...
                        <a href="#" class="inline-flex items-center font-medium text-primary-600">
                            Details 
